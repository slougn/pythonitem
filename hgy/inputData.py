...
LastEditTime: 2022-05-03 15:52:06
LastEditors: 560130
Description: 
...
Pchwp2 = np.array([0,0,3309,9529,37528,36318,84028,84028,36318,37528,9529,0])
...
def Fobj(param):
    y_24 = (Pch + Pchw + Pcw + Pcwt) * param
    y_12 =  (y_24[:12].sum(axis=1) + y_24[12:].sum(axis=1))
    Tm_12 = (R[:12] + R[12:]).sum(axis=1) * 0.05
    S_12 = y_12 + Tm_12 + Pchwp2
    out = sum(abs(S_12 - Out))
    return out
